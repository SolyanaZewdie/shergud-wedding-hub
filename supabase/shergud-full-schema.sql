-- ============================================================
-- SherGud (ሽር ጉድ) — complete database setup
-- Run this once in your own Supabase project: SQL Editor -> New query -> paste -> Run.
-- Safe on an empty project. Creates: enums, 10 tables, 1 public view,
-- helper functions, triggers, grants, RLS policies, storage policies.
-- Before running: create a PRIVATE storage bucket named exactly "vendor-portfolio"
-- (Storage -> New bucket -> name: vendor-portfolio, Public: off, file size limit: 10 MB).
-- ============================================================
-- roles
